...
public class LCDWriteTextTest3 {

    public static Logger LOGGER = LoggerFactory.getLogger(LCDWriteTextTest3.class);
    ...
    public static void writeMessage(final String message){
        ...
        lcd.setColor(0,0,0);
        lcd.drawSubstring(message, 2,message.length(), 50, 50, 0);
        lcd.refresh();
    }
