...
public class LCDWriteTextTest5 {

    public static Logger LOGGER = LoggerFactory.getLogger(LCDWriteTextTest5.class);
    ...
    public static void writeMessage(final String message){
        ...
        lcd.setColor(0,0,0);
        lcd.drawChars(message.toCharArray(),0,  message.toCharArray().length, 50, 50, 0);
        lcd.refresh();
    }
